...
namespace OgawaPortal.Module.BusinessObjects.Logistic
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        private PickListExhange _PickListExhange;
        [Association("PickListExhange-DetailsBO")]
        [Index(99), VisibleInListView(false), VisibleInDetailView(false), VisibleInLookupListView(false)]
        [Appearance("PickListExhange", Enabled = false)]
        public PickListExhange PickListExhange
        {
            get { return _PickListExhange; }
            set { SetPropertyValue("PickListExhange", ref _PickListExhange, value); }
        }
