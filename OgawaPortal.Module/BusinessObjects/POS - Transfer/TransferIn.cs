...
namespace OgawaPortal.Module.BusinessObjects.POS___Transfer
{
    ...
    [XafDisplayName("POS Transfer In List")]
    ...
    [Appearance("HideSubmit", AppearanceItemType = "Action", TargetItems = "SubmitTransferIn", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    [Appearance("HideSubmit2", AppearanceItemType = "Action", TargetItems = "SubmitTransferIn", Criteria = "not (Status in (6))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    
    public class TransferIn : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public TransferIn(Session session)
            : base(session)
        {
        }
        ...
        [Association("TransferIn-DetailsBO")]
        [XafDisplayName("Items")]
        [Appearance("DetailsBO", Enabled = false, Criteria = "not (Status in (6))")]
        public XPCollection<TransferInDetails> DetailsBO
        {
            get { return GetCollection<TransferInDetails>("DetailsBO"); }
        }
