...
namespace OgawaPortal.Module.BusinessObjects.Exchange
{
    [DefaultClassOptions]
    [NavigationItem("POS - Exchange")]
    [XafDisplayName("Print Goods Return Note")]
    ...
    [Appearance("HideSubmit", AppearanceItemType = "Action", TargetItems = "SubmitSalesGRN", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("HideCancel", AppearanceItemType = "Action", TargetItems = "CancelSalesGRN", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    [Appearance("HideSubmit2", AppearanceItemType = "Action", TargetItems = "SubmitSalesGRN", Criteria = "not (Status in (0))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("HideCancel2", AppearanceItemType = "Action", TargetItems = "CancelSalesGRN", Criteria = "not (Status in (0))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    public class PrintGRN : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public PrintGRN(Session session)
            : base(session)
        {
        }
        ...
        private DateTime _GoodsReturnDate;
        [XafDisplayName("Goods Return Date")]
        [Index(2), VisibleInListView(true), VisibleInDetailView(true), VisibleInLookupListView(true)]
        [Appearance("GoodsReturnDate", Enabled = false, Criteria = "not (Status in (0))")]
        public DateTime GoodsReturnDate
        {
            get { return _GoodsReturnDate; }
            set
            {
                SetPropertyValue("GoodsReturnDate", ref _GoodsReturnDate, value);
            }
        }
        ...
        [Appearance("GRNRefNo", Enabled = false, Criteria = "not (Status in (0))")]
        public string GRNRefNo
        {
            get { return _GRNRefNo; }
            set
            {
                SetPropertyValue("GRNRefNo", ref _GRNRefNo, value);
            }
        }

        private ExchangeType _ExchangeType;
        [XafDisplayName("Exchange Type")]
        [DataSourceCriteria("IsActive = True")]
        [ImmediatePostData]
        [Index(6), VisibleInListView(true), VisibleInDetailView(true), VisibleInLookupListView(true)]
        [Appearance("ExchangeType", Enabled = false, Criteria = "not (Status in (0))")]
        ...
        public ExchangeType ExchangeType
        {
            ...
            set
            {
                SetPropertyValue("ExchangeType", ref _ExchangeType, value);
            }
        }

        private string _ExchangeReason;
        [XafDisplayName("Exchange Reason")]
        [Index(7), VisibleInListView(true), VisibleInDetailView(true), VisibleInLookupListView(true)]
        [Appearance("ExchangeReason", Enabled = false, Criteria = "not (Status in (0))")]
        public string ExchangeReason
        {
            get { return _ExchangeReason; }
            set
            {
                SetPropertyValue("ExchangeReason", ref _ExchangeReason, value);
            }
        }
        ...
        [Association("PrintGRN-DetailsBO")]
        [XafDisplayName("Items")]
        [Appearance("DetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<PrintGRNDetails> DetailsBO
        {
            get { return GetCollection<PrintGRNDetails>("DetailsBO"); }
        }

        [Association("PrintGRN-PaymentDetailsBO")]
        [XafDisplayName("Payment")]
        [Appearance("PaymentDetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<PrintGRNPayment> PaymentDetailsBO
        {
            get { return GetCollection<PrintGRNPayment>("PaymentDetailsBO"); }
        }
