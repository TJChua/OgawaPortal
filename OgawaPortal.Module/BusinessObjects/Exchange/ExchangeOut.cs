...
namespace OgawaPortal.Module.BusinessObjects.Exchange
{
    ...
    [Appearance("HideSubmit", AppearanceItemType = "Action", TargetItems = "SubmitSalesExchangeOut", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("HideCancel", AppearanceItemType = "Action", TargetItems = "CancelSalesExchangeOut", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    [Appearance("HideSubmit2", AppearanceItemType = "Action", TargetItems = "SubmitSalesExchangeOut", Criteria = "not (Status in (0))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("HideCancel2", AppearanceItemType = "Action", TargetItems = "CancelSalesExchangeOut", Criteria = "not (Status in (0))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    public class ExchangeOut : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public ExchangeOut(Session session)
            : base(session)
        {
        }
        ...
        [Appearance("DocDate", Enabled = false, Criteria = "not (Status in (0))")]
        ...
        [Association("ExchangeOut-DetailsBO")]
        [XafDisplayName("Items")]
        [Appearance("DetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<ExchangeOutDetails> DetailsBO
        {
            get { return GetCollection<ExchangeOutDetails>("DetailsBO"); }
        }

        [Association("ExchangeOut-PaymentDetailsBO")]
        [XafDisplayName("Payment")]
        [Appearance("PaymentDetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<ExchangeOutPayment> PaymentDetailsBO
        {
            get { return GetCollection<ExchangeOutPayment>("PaymentDetailsBO"); }
        }
