...
namespace OgawaPortal.Module.BusinessObjects.Warehouse
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        private TransferPickList _TransferPickList;
        [Association("TransferPickList-DetailsBO")]
        [Index(99), VisibleInListView(false), VisibleInDetailView(false), VisibleInLookupListView(false)]
        [Appearance("TransferPickList", Enabled = false)]
        public TransferPickList TransferPickList
        {
            get { return _TransferPickList; }
            set { SetPropertyValue("TransferPickList", ref _TransferPickList, value); }
        }
