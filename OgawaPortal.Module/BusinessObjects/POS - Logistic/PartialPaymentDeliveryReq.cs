...
namespace OgawaPortal.Module.BusinessObjects.POS___Logistic
{
    ...
    [XafDisplayName("Partial Payment Delivery Request")]
    ...
    [Appearance("HideSubmit", AppearanceItemType = "Action", TargetItems = "SubmitPartialPayment", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("HideCancel", AppearanceItemType = "Action", TargetItems = "CancelPartialPayment", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    [Appearance("HideSubmit2", AppearanceItemType = "Action", TargetItems = "SubmitPartialPayment", Criteria = "not (Status in (0))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("HideCancel2", AppearanceItemType = "Action", TargetItems = "CancelPartialPayment", Criteria = "not (Status in (0))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    public class PartialPaymentDeliveryReq : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public PartialPaymentDeliveryReq(Session session)
            : base(session)
        {
        }
        ...
        [Appearance("DRRefNo", Enabled = false, Criteria = "not (Status in (0))")]
        ...
        [Appearance("Sales Order No.", Enabled = false)]
        ...
        [Appearance("SO Ref No.", Enabled = false)]
        ...
        [Association("PartialPaymentDeliveryReq-DetailsBO")]
        [XafDisplayName("Items")]
        [Appearance("DetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<PartialPaymentDeliveryReqDetails> DetailsBO
        {
            get { return GetCollection<PartialPaymentDeliveryReqDetails>("DetailsBO"); }
        }

        [Association("PartialPaymentDeliveryReq-PaymentDetailsBO")]
        [XafDisplayName("Payment")]
        [Appearance("PaymentDetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<PartialPaymentDeliveryReqPayment> PaymentDetailsBO
        {
            get { return GetCollection<PartialPaymentDeliveryReqPayment>("PaymentDetailsBO"); }
        }

        [Association("PartialPaymentDeliveryReq-AttachmentDetailsBO")]
        [XafDisplayName("Proof of Documents")]
        [Appearance("AttachmentDetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<PartialPaymentDeliveryReqAttach> AttachmentDetailsBO
        {
            get { return GetCollection<PartialPaymentDeliveryReqAttach>("AttachmentDetailsBO"); }
        }
