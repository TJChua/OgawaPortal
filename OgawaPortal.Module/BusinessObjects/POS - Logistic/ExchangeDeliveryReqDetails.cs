...
{
    [DefaultClassOptions]
    [XafDisplayName("Exchange Delivery Request Details")]
    [Appearance("HideNew", AppearanceItemType.Action, "True", TargetItems = "New", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide, Context = "Any")]
    [Appearance("LinkDoc", AppearanceItemType = "Action", TargetItems = "Link", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("UnlinkDoc", AppearanceItemType = "Action", TargetItems = "Unlink", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    public class ExchangeDeliveryReqDetails : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public ExchangeDeliveryReqDetails(Session session)
            : base(session)
        {
        }
        ...
        private ExchangeDeliveryReq _ExchangeDeliveryReq;
        [Association("ExchangeDeliveryReq-DetailsBO")]
        [Index(99), VisibleInListView(false), VisibleInDetailView(false), VisibleInLookupListView(false)]
        [Appearance("ExchangeDeliveryReq", Enabled = false)]
        public ExchangeDeliveryReq ExchangeDeliveryReq
        {
            get { return _ExchangeDeliveryReq; }
            set { SetPropertyValue("ExchangeDeliveryReq", ref _ExchangeDeliveryReq, value); }
        }
