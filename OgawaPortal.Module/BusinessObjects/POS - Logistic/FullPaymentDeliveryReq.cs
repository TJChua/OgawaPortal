...
namespace OgawaPortal.Module.BusinessObjects.POS___Logistic
{
    ...
    [XafDisplayName("Full Payment Delivery Request")]
    ...
    [Appearance("HideSubmit", AppearanceItemType = "Action", TargetItems = "SubmitFullPayment", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("HideCancel", AppearanceItemType = "Action", TargetItems = "CancelFullPayment", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    [Appearance("HideSubmit2", AppearanceItemType = "Action", TargetItems = "SubmitFullPayment", Criteria = "not (Status in (0))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("HideCancel2", AppearanceItemType = "Action", TargetItems = "CancelFullPayment", Criteria = "not (Status in (0))", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]

    public class FullPaymentDeliveryReq : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public FullPaymentDeliveryReq(Session session)
            : base(session)
        {
        }
        ...
        [Association("FullPaymentDeliveryReq-DetailsBO")]
        [XafDisplayName("Items")]
        [Appearance("DetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<FullPaymentDeliveryReqDetails> DetailsBO
        {
            get { return GetCollection<FullPaymentDeliveryReqDetails>("DetailsBO"); }
        }
        ...
        public XPCollection<FullPaymentDeliveryReqPayment> PaymentDetailsBO
        {
            get { return GetCollection<FullPaymentDeliveryReqPayment>("PaymentDetailsBO"); }
        }

        [Association("FullPaymentDeliveryReq-AttachmentDetailsBO")]
        [XafDisplayName("Proof of Documents")]
        [Appearance("AttachmentDetailsBO", Enabled = false, Criteria = "not (Status in (0))")]
        public XPCollection<FullPaymentDeliveryReqAttach> AttachmentDetailsBO
        {
            get { return GetCollection<FullPaymentDeliveryReqAttach>("AttachmentDetailsBO"); }
        }
