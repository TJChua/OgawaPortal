...
namespace OgawaPortal.Module.Controllers
{
    ...
    public partial class ResumeBackOrderControllers : ViewController
    {
        // Use CodeRush to create Controllers and Actions with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/403133/
        public ResumeBackOrderControllers()
        {
            InitializeComponent();
        ...
        protected override void OnViewControlsCreated()
        {
            ...
            if (View.Id == "POSSales_DetailView_RsmBackOrder")
            {
                //this.BackToInquiry.Active.SetItemValue("Enabled", true);
                if (((DetailView)View).ViewEditMode == ViewEditMode.View)
                {
                    this.ResumeOrder.Active.SetItemValue("Enabled", true);
                }
                else
                {
                    this.ResumeOrder.Active.SetItemValue("Enabled", false);
                }
            }
            else
            {
        ...
        private void ResumeOrder_Execute(object sender, PopupWindowShowActionExecuteEventArgs e)
        {
        ...
        private void ResumeOrder_CustomizePopupWindowParams(object sender, CustomizePopupWindowParamsEventArgs e)
        {
            IObjectSpace os = Application.CreateObjectSpace();
